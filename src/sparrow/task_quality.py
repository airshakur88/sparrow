...
GROUNDED_FIXTURE_SHA256 = (
    "d7e5a6eacd6d326e38ace0a7204cd35d2c86706d0ff6a53b8481a422c7f1afd8"
)
...
def user_task_evidence_path() -> Path:
    override = os.environ.get("SPARROW_TASK_EVIDENCE_FILE")
    if override:
        return Path(override).expanduser()
    return Path.home() / ".config" / "sparrow" / "task_evidence.json"
